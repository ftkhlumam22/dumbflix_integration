...
import (
	...
	"log"
	"net/http"
	authdto "testdumpflix/dto/auth"
	dto "testdumpflix/dto/result"
	"testdumpflix/models"
	"testdumpflix/pkg/bcrypt"
	jwtToken "testdumpflix/pkg/jwt"
...
func HandlerAuth(AuthRepository repositories.AuthRepository, UserRepository repositories.UserRepository) *handlerAuth {
	return &handlerAuth{AuthRepository, UserRepository}
}
...
func (h *handlerAuth) Register(w http.ResponseWriter, r *http.Request) {
	...
	emailFound, _ := h.UserRepository.FindUserByEmail(request.Email)
